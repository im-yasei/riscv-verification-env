...
function logic ldF0poVEX4(input logic F8w8Agr, SQ5L2T, Hfvec, weM, ziZG3f3w85eBr);
  case ({
    F8w8Agr, SQ5L2T, Hfvec, weM, ziZG3f3w85eBr
  })
...
function logic VL5PghYXdkG6kEn(input logic F8w8Agr, SQ5L2T, Tc1U, weM, ziZG3f3w85eBr);
  case ({
    F8w8Agr, SQ5L2T, Tc1U, weM, ziZG3f3w85eBr
  })
...
function logic WmQYuPf7wm0(input logic F8w8Agr, SQ5L2T, Tc1U, Hfvec, ziZG3f3w85eBr);
  case ({
    F8w8Agr, SQ5L2T, Tc1U, Hfvec, ziZG3f3w85eBr
  })
...
module processor_core (
  ...
  logic        vchjfm;
  logic [ 1:0] uBH1Gp;
  logic        ziZG3f3w85eBr /*verilator public_flat_rw*/;
  logic        UcLmtF;
  logic        kSk;
  logic        a6ln;
  logic        TIO8;
  ...
  assign dmdxZ = fwSfv[31] ? {gYB5AZf7Kq1I6, fwSfv[31:20]} : {DWlTlqRLiKeFQ, fwSfv[31:20]};
  ...
  assign bysc1V2cT = UcLmtF ? EwU9w : FBCHA;
  assign tsAQZ5bKX = WkwDlaJY & UcLmtF | kSk ? bysc1V2cT : 'd4;
  assign Eew7nvb5T = a6ln ? {RPgcnv34Ab8[31:1], 1'b0} : KD + tsAQZ5bKX;
  ...
  assign txJRD = fwSfv[19] ? {gYB5AZf7Kq1I6, fwSfv[19:15]} : {DWlTlqRLiKeFQ, fwSfv[19:15]};
  assign Y54pg83z5 = TIO8 ? hAkC : HdVOT0c25;

  assign JYPAbNp3k = C56l2 == 'd0 ? aswkfYVCHk : C56l2 == 'd1 ? KD : 'd0;
  ...
  assign oKihdL = uBH1Gp == 'd1 ? mem_rd_i : uBH1Gp == 'd2 ? zuVaW6J9Fuz1f : VvGqYiZH0Q;
  ...
  always_comb begin
    ...
    case (Pv09590YSbZIv4)
      'b0: mem_req_o = 'b0;
      'b1: mem_req_o = 'b1;
      default: mem_req_o = 1'b0;
    endcase
    case (vNHUYwUZvaeU4)
      'b0: mem_we_o = 'b0;
      'b1: mem_we_o = 'b1;
      default: mem_we_o = 1'b0;
    endcase
    case (pSbkt4Sk4Y)
      'b0: iMdRf = 'b0;
      'b1: iMdRf = 'b1;
